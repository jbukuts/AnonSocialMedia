...
const routes = [
    ...
    {
        path: 'new-item',
        loadChildren: () => Promise.all(/*! import() | new-item-new-item-module */[__webpack_require__.e("default~new-item-new-item-module~product-detail-product-detail-module~reply-modal-reply-modal-module"), __webpack_require__.e("new-item-new-item-module")]).then(__webpack_require__.bind(null, /*! ./new-item/new-item.module */ "./src/app/new-item/new-item.module.ts")).then(m => m.NewItemPageModule)
    },
    {
        path: 'product-detail',
    ...
    {
        path: 'order-detail',
        loadChildren: () => __webpack_require__.e(/*! import() | order-detail-order-detail-module */ "order-detail-order-detail-module").then(__webpack_require__.bind(null, /*! ./order-detail/order-detail.module */ "./src/app/order-detail/order-detail.module.ts")).then(m => m.OrderDetailPageModule)
    },
    {
        path: 'reply-modal',
    ...
    {
        path: 'your-posts',
        loadChildren: () => __webpack_require__.e(/*! import() | your-posts-your-posts-module */ "your-posts-your-posts-module").then(__webpack_require__.bind(null, /*! ./your-posts/your-posts.module */ "./src/app/your-posts/your-posts.module.ts")).then(m => m.YourPostsPageModule)
    },
    {
        path: 'search-posts',
        loadChildren: () => __webpack_require__.e(/*! import() | search-posts-search-posts-module */ "search-posts-search-posts-module").then(__webpack_require__.bind(null, /*! ./search-posts/search-posts.module */ "./src/app/search-posts/search-posts.module.ts")).then(m => m.SearchPostsPageModule)
    },
    {
        path: 'app-info',
        loadChildren: () => __webpack_require__.e(/*! import() | app-info-app-info-module */ "app-info-app-info-module").then(__webpack_require__.bind(null, /*! ./app-info/app-info.module */ "./src/app/app-info/app-info.module.ts")).then(m => m.AppInfoPageModule)
    },
    {
        path: 'change-theme',
        loadChildren: () => __webpack_require__.e(/*! import() | change-theme-change-theme-module */ "change-theme-change-theme-module").then(__webpack_require__.bind(null, /*! ./change-theme/change-theme.module */ "./src/app/change-theme/change-theme.module.ts")).then(m => m.ChangeThemePageModule)
    },
    {

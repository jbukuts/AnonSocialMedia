...
var routes = [
    ...
    {
        path: 'new-item',
        loadChildren: function () { return Promise.all(/*! import() | new-item-new-item-module */[__webpack_require__.e("default~new-item-new-item-module~product-detail-product-detail-module~reply-modal-reply-modal-module"), __webpack_require__.e("new-item-new-item-module")]).then(__webpack_require__.bind(null, /*! ./new-item/new-item.module */ "./src/app/new-item/new-item.module.ts")).then(function (m) { return m.NewItemPageModule; }); }
    },
    {
        path: 'product-detail',
    ...
    {
        path: 'order-detail',
        loadChildren: function () { return __webpack_require__.e(/*! import() | order-detail-order-detail-module */ "order-detail-order-detail-module").then(__webpack_require__.bind(null, /*! ./order-detail/order-detail.module */ "./src/app/order-detail/order-detail.module.ts")).then(function (m) { return m.OrderDetailPageModule; }); }
    },
    {
        path: 'reply-modal',
        loadChildren: function () { return Promise.all(/*! import() | reply-modal-reply-modal-module */[__webpack_require__.e("default~new-item-new-item-module~product-detail-product-detail-module~reply-modal-reply-modal-module"), __webpack_require__.e("default~product-detail-product-detail-module~reply-modal-reply-modal-module")]).then(__webpack_require__.bind(null, /*! ./reply-modal/reply-modal.module */ "./src/app/reply-modal/reply-modal.module.ts")).then(function (m) { return m.ReplyModalPageModule; }); }
    },
    {
        path: 'image-modal',
    ...
    {
        path: 'settings',
        loadChildren: function () { return __webpack_require__.e(/*! import() | settings-settings-module */ "settings-settings-module").then(__webpack_require__.bind(null, /*! ./settings/settings.module */ "./src/app/settings/settings.module.ts")).then(function (m) { return m.SettingsPageModule; }); }
    },
    {
        path: 'your-posts',
        loadChildren: function () { return __webpack_require__.e(/*! import() | your-posts-your-posts-module */ "your-posts-your-posts-module").then(__webpack_require__.bind(null, /*! ./your-posts/your-posts.module */ "./src/app/your-posts/your-posts.module.ts")).then(function (m) { return m.YourPostsPageModule; }); }
    },
    {
        path: 'search-posts',
        loadChildren: function () { return __webpack_require__.e(/*! import() | search-posts-search-posts-module */ "search-posts-search-posts-module").then(__webpack_require__.bind(null, /*! ./search-posts/search-posts.module */ "./src/app/search-posts/search-posts.module.ts")).then(function (m) { return m.SearchPostsPageModule; }); }
    },
    {
        path: 'app-info',
        loadChildren: function () { return __webpack_require__.e(/*! import() | app-info-app-info-module */ "app-info-app-info-module").then(__webpack_require__.bind(null, /*! ./app-info/app-info.module */ "./src/app/app-info/app-info.module.ts")).then(function (m) { return m.AppInfoPageModule; }); }
    },
    {
        path: 'change-theme',
        loadChildren: function () { return __webpack_require__.e(/*! import() | change-theme-change-theme-module */ "change-theme-change-theme-module").then(__webpack_require__.bind(null, /*! ./change-theme/change-theme.module */ "./src/app/change-theme/change-theme.module.ts")).then(function (m) { return m.ChangeThemePageModule; }); }
    },
    {
...
module.exports = __webpack_require__(/*! /home/jbukuts/Documents/Github/AnonSocialMedia/src/main.ts */"./src/main.ts");
